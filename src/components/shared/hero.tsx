...
export function Hero({
  title = 'React Rsbuild Boilerplate',
  subtitle = 'Build faster, ship sooner',
  description = 'A modern, scalable React application boilerplate built with Rsbuild, TypeScript, and the latest development tools.',
  primaryAction = {
    label: 'Get Started',
    href: '/auth/register',
  },
